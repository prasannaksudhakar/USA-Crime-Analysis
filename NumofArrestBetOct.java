...
public class NumofArrestBetOct {
...
j.setJarByClass(NumofArrestBetOct.class);
...
try 
{
  ...
  String StrYear = words[2].toUpperCase().trim();               
  String StrArrests = words[8].toUpperCase().trim(); 
  Date YearDate=new  
  SimpleDateFormat("dd/MM/yyyy").parse(StrYear);   
  
  if ((YearDate.before(new  Date("31/10/2015")))&&(YearDate.after(new Date("01/10/2014"))))
  {
